    ...
    <div className='min-h-screen bg-cover bg-no-repeat flex items-center justify-center'>
      ...
      <div className='w-5/6 max-w-2xl backdrop-blur-2xl text-black border-2 border-gray-600 flex items-center justify-between max-sm:flex-col-reverse rounded-lg'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-5 p-10 flex-1' >
          <h3 className=' text-black text-3xl'>Profile Details</h3>
        ...
        Upload Profile Pic 
          ...
          <button type='submit' className='bg-gradient-to-r from-purple-900 to -violet-600 text-white p-2 rounded-full text-lg cursor-pointer'>Save</button>
        </form>
